...
INSERT INTO "new_Contact" ("createdAt", "createdBy", "email", "id", "interviewId", "name", "lastTouchedAt") SELECT "createdAt", "createdBy", "email", "id", "interviewId", "name", "lastTouchedAt" FROM "Contact";
DROP TABLE "Contact";
...
CREATE INDEX "Contact_lastTouchedAt_idx" ON "Contact"("lastTouchedAt");
