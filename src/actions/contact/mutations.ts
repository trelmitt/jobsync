...
// Fork-only — bumped by the "mark followed up" action, drives the dashboard
// stale-contacts widget. Not part of upstream's contact model.
export const touchContact = async (
  ...
  try {
    ...
    return handleError(error, "Failed to mark contact as followed up.");
  }
};
